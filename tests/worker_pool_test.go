...
// 	ctx := context.Background()
// 	wp, _ := throttler.NewWorkerPool(ctx, throttler.WithWorkers(8), throttler.WithRateLimit(10)) // 10 tasks per second
// 	wp.Start()
// 	defer wp.Stop()
...
// 	ctx := context.Background()
// 	wp, _ := throttler.NewWorkerPool(ctx, throttler.WithWorkers[any, any](2), throttler.WithRateLimit[any, any](10000)) // 5 tasks/sec
// 	wp.Start()
// 	defer wp.Stop()
...
// 		resultChan, _ := wp.AddTask(throttler.TaskOptions{
// 			ID:         "retry-task",
// 			MaxRetries: 1,
